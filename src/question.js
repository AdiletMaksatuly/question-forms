export class Question {
   static create(question) {
      return fetch('https://question-forms-default-rtdb.firebaseio.com/questions.json', {
         method: 'POST',
   ...
   static fetch(token) {
      ...
      return fetch(`https://question-forms-default-rtdb.firebaseio.com/questions.json?=auth=${token}`)
         .then(response => response.json())
         .then(response => {
